...
export default {
  ...
  global: {
    fieldset: 'max-w-md  px-2 pb-1',
    help: 'text-xs text-gray-500',
    inner: 'formkit-disabled:bg-white formkit-disabled:cursor-not-allowed formkit-disabled:pointer-events-none',
    input: 'appearance-none focus:outline-none focus:ring-0 focus:shadow-none rounded-md',
  ...
  'family:button': {
    input: '$reset inline-flex items-center bg-primary text-white text-sm font-normal py-3 px-6 rounded focus-visible:outline-2 focus-visible:outline-blue-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin',
    wrapper: 'mb-1',
